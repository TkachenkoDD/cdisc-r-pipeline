...
# ==============================================================================
get_meta_cached <- function(spec_path = "02_adam/02_doc/ADAM_spec.xlsx",
                            rds_path  = "02_adam/02_doc/meta.rds",
                            force = FALSE){
...
get_adam_meta <- function(spec_path = "02_adam/02_doc/ADAM_spec.xlsx"){
